...
export default function OurWork() {
 ...
 <div className="sm:ms-12 sm:me-12">
      ...
      <div className="flex justify-center items-center text-center px-[60px] pb-[70px] ">
        <p className="text-secondary font-mons text-[15px] sm:text-[20px] font-[400] leading-[30px] tracking-[0.4px] text-[#666]  dark:text-white">
        ...
        >
          {logos.map((icon, index) => (
            <SwiperSlide key={index} className="flex justify-center lg:4/12 md:6/12 ">
      ...
      <div className=" mt-[100px] mb-14 flex justify-center items-center">
        ...
        <p className="ps-2 font-mons text-hover  font-bold text-[16px] text-[#003540] tracking-[1.6px] dark:text-[#B3E5F1]">
          What We Did
        </p>
      </div>

      <div className="flex justify-center items-center text-center dark:text-[#B3E5F1] text-[#003540] ">
        <h2 className="sm:text-5xl text-[20px] font-mons font-bold mb-[10px] sm:mb-[20px] sm:px-[150px] text-center  sm:tracking-[4.8px] leading-[75px] dark:text-white">
