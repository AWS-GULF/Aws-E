  ...
  return (
    <div>
      <div className="sm:ms-12 sm:me-12">
        <div
          className={`${
            i18n.language === "ar" && "flex-row-reverse gap-2"
          } mt-4 sm:mt-16 mb-8 sm:mb-14 flex justify-center dark:text-[#B3E5F1] items-center  text-[#003540] text-lg `}
        >
          <img
            src={QualityAssurance}
            alt="QualityAssurance"
            className={` ${
              i18n.language === "ar" && "w-8"
            } dark:text-[#B3E5F1]`}
          />
          <p
        ...
        <div className="flex justify-center items-center text-[#003540] dark:text-[#B3E5F1] ">
          <h2
            className={`lg:text-5xl sm:text-3xl text-[20px] ${
              i18n.language === "en" && "font-montserrat sm:tracking-[4.8px]"
            } font-bold mb-[10px] sm:mb-[40px] sm:px-[150px] text-center  leading-[75px] text-primary ${
              i18n.language === "ar" &&
              "tracking-[0px] lg:tracking-[0] font-cairo "
            }`}
          >
        ...
        <div className="flex justify-center items-center text-center px-[60px] pb-[70px] ">
          <p
            className={`${
              i18n.language === "ar" &&
              "tracking-[0px] sm:text-[25px] font-cairo "
      ...
      <div
        className={`${
          i18n.language === "ar" && "flex-row-reverse gap-2"
        } mt-[100px] mb-14 flex justify-center items-center`}
      >
        <img
          src={QualityAssurance}
          alt="QualityAssurance"
        ...
        <p
          className={` ${
            i18n.language === "ar" &&
            "  font-cairo tracking-[0px] sm:text-[23px] "
          } ps-2 font-montserrat text-hover font-bold text-[16px] text-[#003540] dark:text-[#B3E5F1]  ${
            i18n.language === "en" && "tracking-[1.6px]"
          }`}
        >
          {t("whatwedid")}{" "}
      ...
      <div className="flex justify-center items-center text-center dark:text-[#B3E5F1] text-[#003540]">
        <h2
          className={`${
            i18n.language === "ar" &&
            "tracking-[0px] lg:tracking-[0] font-cairo  "
          } sm:text-5xl text-[20px] font-montserrat ${
            i18n.language === "en" && "sm:tracking-[4.8px] "
          } font-bold mb-[10px] sm:mb-[20px] sm:px-[150px] text-center  leading-[75px] dark:text-white`}
        >
          {t("opv")}
        </h2>
      </div>
      ...
      <div className="flex justify-center items-center text-center px-[60px] pb-[42px] dark:text-white text-[#666]">
        <p
          className={`${
            i18n.language === "ar" &&
            "tracking-[0px] sm:text-[25px] lg:mt-4 font-cairo"
          }  text-secondary font-montserrat text-[15px] sm:text-[20px] font-[400] leading-[30px] tracking-[0.4px] text-[#666] dark:text-white`}
        >
          {t("since")}
        </p>
