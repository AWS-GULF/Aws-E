    ...
    return (
        <div className="sm:ms-12 sm:me-12 text-xl  ">
            <div className="mt-16 mb-14 flex justify-center items-center">
                ...
                <p className="ps-2 font-montserrat text-hover text-lg font-montserrat text-[#003540] dark:text-[#B3E5F1] font-bold text-[16px] tracking-[1.6px]">
                    Services
                </p>
            </div>
        
            <div className="flex-col justify-center items-center">
                <h2 className="text-4xl font-montserrat font-bold mb-[80px] text-center tracking-[4.8px] leading-[75px] dark:text-[#B3E5F1]">
                    Innovative IT and software solutions to bring your ideas to life and drive success
                </h2>
                <p className="mt-5 text-center pb-[70px] text-[#666] dark:text-white font-normal px-5 font-montserrat text-[20px] tracking-[2px] leading-[35px] text-secondary">
            ...
            <h2 className="text-center font-montserrat text-[32px] text-[#003540] dark:text-[#B3E5F1] font-bold tracking-[3.2px] pb-8">
                Services
            </h2>

            <div className="flex justify-center items-center pb-16">
                <ul className="flex justify-center items-center">
                    <li className="pe-6 font-montserrat text-[16px] text-[#003540] dark:text-[#B3E5F1] font-bold p-4 hover:bg-hover hover:rounded-[10px] hover:transition-all hover:duration-200">
                        <Link
                            to="ITHardware"
                            spy={true}
                            smooth={true}
                    ...
                    <li className="pe-6 font-montserrat text-[16px] text-primary dark:text-[#B3E5F1] font-bold p-4 hover:bg-hover hover:rounded-[10px] hover:transition-all hover:duration-200">
                        <Link
                            to="Data Center"
                            spy={true}
                            smooth={true}
            ...
            <Element name="ITHardware">
                <div className="flex-col justify-start items-start px-12">
                    <h2 className="font-montserrat text-[32px] tracking-[3.2px] font-[500] text-[#003540] dark:text-[#B3E5F1] pb-5">
                        IT Professional Services
                    </h2>
                    <p className="text-[#666] dark:text-white font-montserrat text-[20px] tracking-[2px] leading-[30px] ps-1">
            ...
            <div className="flex justify-start items-start px-12 pt-8 mb-[60px]">
                <div className="flex-col justify-start items-start w-full md:w-3/4">
                    <h4 className="font-montserrat text-[#000] dark:text-[#B3E5F1] pb-4 text-[20px] tracking-[2px] font-[600]">
                        1- IT Hardware Products:
                    </h4>
                    <p className="font-montserrat text-[#666] dark:text-white text-[16px] tracking-[1.6px] leading-[30px] font-normal">
                        Providing high-quality IT hardware products to ensure optimal performance and reliability for your infrastructure.
                    </p>
                    <h4 className="font-montserrat text-[#000] dark:text-[#B3E5F1] pb-4 pt-6 text-[20px] tracking-[2px] font-[600]">
            ...
            <Element name="Data Center">
                <div className="flex-col justify-start items-start px-12">
                    <h2 className="font-montserrat text-[32px] text-[#003540] dark:text-[#B3E5F1] tracking-[3.2px] font-[500] pb-5">
                        Data Center Development
                    </h2>
                    <p className="text-[#666] dark:text-white font-montserrat text-[20px] tracking-[2px] leading-[30px] ps-1">
