      ...
      <div className="px-6 sm:px-0">
        <div className="  sm:ms-12 sm:me-12">
          ...
          <div className="sm:flex sm:flex-row flex-col justify-start items-start sm:px-12 sm:pt-8 sm:mb-[60px]  ">
            ...
            <div className="ps-4 w-3/4 m-auto ms-20    hidden sm:block ">
              <img
                src={QualityAssurance}
                className="w-full"
                alt=""
          ...
          <div className="sm:flex sm:flex-row flex-col justify-start gap-20 items-start sm:px-12 sm:pt-8 sm:mb-[60px] bg--950   ">
