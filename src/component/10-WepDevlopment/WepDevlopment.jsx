  ...
  return (
    <div className="px-6 sm:px-12 lg:px-24 ">
      <div className="mt-16 mb-14 flex justify-center items-center text-xl ">
        ...
        <p
          className={` ps-2 font-montserrat font-bold text-lg tracking-wide text-[#295F70] dark:text-[#B3E5F1]  ${
            i18n.language === "ar" && "font-cairo text-[34px]"
          } `}
        >
          {t("services")}
        </p>
      ...
      <div className="text-center mb-20">
        <h2
          className={`text-md sm:text-2xl font-montserrat lg:text-4xl font-bold   leading-tight text-[#003540] dark:text-[#B3E5F1]  ${
            i18n.language === "ar" && "font-cairo leading-8"
          }`}
        >
          {t("web")}
        </h2>
      ...
      <div className="flex sm:justify-center overflow-scroll md:overflow-hidden scrollbar sm:overflow-hidden  lg:w-fit lg:ps-10  lg:h-30  sm:mb-[100px] mb-8 ">
        <div className="flex gap-2 sm:w-full justify-center items-center lg:w-full ">
          <img
            src={kotlin}
            className=" lg:pe-12 lg:pt-6 lg:w-1/6 lg:h-[160px]    "
            alt="kotlin"
          />
          <img
            src={oracle}
            className=" lg:pe-12   lg:w-1/5 p-4  lg:h-[120px] "
            alt="oracle"
          />
          <img
            src={python}
      ...
      <div className="text-center mb-10">
        ...
        <p className={` pb-8 text-aboutCont text-lg text-[#666] font-montserrat dark:text-white  leading-relaxed text-center  ${
            i18n.language === "ar" && "font-cairo"
          }`}>
          {t("webDesc")}{" "}
        </p>
      ...
      {[
        ...
        >
          <div className="sm:w-1/2 lg:w-2/3 text-center sm:text-left">
            <h4 className={` ${i18n.language==='ar'&& "lg:text-end text-center font-cairo"} text-xl font-semibold mb-4 text-[#003540] dark:text-[#B3E5F1]`}>
              {section.title}
            </h4>
            <p className={` ${i18n.language==='ar'&& "lg:text-end text-center font-cairo "} text-lg leading-relaxed text-[#333] dark:text-white`}>
              {section.desc}
            </p>
          </div>
