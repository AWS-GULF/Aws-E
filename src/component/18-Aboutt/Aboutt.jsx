    ...
    <div className="px-6 sm:px-0">
      <div className="sm:ms-12 sm:me-12">
        ...
        <div className="mb-12">
          ...
          <p className=" dark:text-white text-aboutCont font-mons text-[16px] sm:text-[16px] mb-8 sm:mb-0 tracking-[1.4px] font-normal leading-[35px]">
        ...
        <div className="flex flex-wrap justify-between sm:flex-nowrap sm:gap-4 mb-[100px]">
          <div className="flex-col ps-5 justify-evenly items-end sm:justify-center sm:items-center w-[45%] sm:w-1/3 mb-4">
            <span className="sm:px-[80px] bg-[#295F70] dark:text-[black] mb-4 px-[10px] py-6 bg-primary rounded-[10px] text-[#fff] font-mons text-[16px] sm:text-[20px] font-[500]">
              OUR VISION
            </span>
            <p className="text-start mt-[30px] text-aboutCont dark:text-white  font-mons text-[10px] sm:text-[16px] tracking-[1.12px] font-normal leading-[16px] sm:leading-[35px]">
          ...
          <div className="flex-col ps-5 justify-evenly items-end sm:justify-center sm:items-center w-[45%] sm:w-1/3 mb-4">
            <span className="bg-[#295F70] dark:text-[black] sm:px-[80px] px-[10px] py-6 bg-primary rounded-[10px] text-[#fff] font-mons text-[16px] sm:text-[20px] font-[500]">
              OUR MESSAGE
            </span>
            <p className="text-start mt-[30px] text-aboutCont dark:text-white  font-mons text-[10px] sm:text-[16px] tracking-[1.12px] font-normal leading-[16px] sm:leading-[35px]">
        ...
        <div className="flex mb-[100px] gap-2">
          <div className="sm:w-[80%] w-[70%] flex-col justify-start sm:items-start items-center">
            <p className="text-aboutCont font-mons text-[18px] dark:text-white  sm:text-[32px] sm:tracking-[6.4px] font-bold leading-[24px] sm:leading-[60px] pb-[30px]">
          ...
          <div className="sm:w-1/2 w-[55%] text-start items-start">
        ...
        <div className="sm:flex-row sm:flex flex-col sm:gap-4 sm:mb-[60px]">
          <div className="sm:w-1/2 w-full mb-4">
            <p className="text-aboutCont dark:text-white  font-mons text-[12px] sm:text-[18px] tracking-[1.4px] leading-[16px] sm:leading-[35px]">
              <span className="text-primary  dark:text-[#B3E5F1] font-bold font-mons text-[16px] sm:text-[26px] tracking-[1.68px] leading-[16px] sm:leading-[35px]">
                Our team
              </span>{" "}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-[100px]">
          <div className="card bg-base-100 w-full p-4 border border-[#E0E0E0] flex flex-col">
