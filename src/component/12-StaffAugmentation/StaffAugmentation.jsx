            ...
            <div className="">
                <div className="">
                    ...
                    <div className="flex justify-center items-center">
                        <h2 className="text-4xl font-montserrat text-[#003540] dark:text-[#B3E5F1] font-bold mb-[80px] text-center tracking-[4.8px] leading-[75px] w-full sm:w-auto">
                    ...
                    <div className="lg:px-[121px] px-14 flex-col justify-center items-center">
                        <h1 className="text-center text-[#003540] dark:text-[#B3E5F1] mb-[20px] text-primary font-montserrat text-[32px] tracking-[3.2px] font-[500] w-full sm:w-auto">
                            Staff Augmentation
                        </h1>
                        <p className="text-aboutCont text-xl text-center text-[#666] dark:text-white font-montserrat font-normal leading-[30px] tracking-[1.6px] mb-[60px] w-full sm:w-auto">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-center lg:px-[121px] px-14 mb-16 gap-16">
                        <div className="w-full sm:w-3/4 pt-14 flex-col justify-center items-center ps-1 mt-[-30px]">
                            <h4 className="font-montserrat text-[20px] font-[600] tracking-[2px] mb-4 dark:text-[#B3E5F1] w-full">
                                Identify: Specialized Skills
                            </h4>
                            <p className="font-montserrat text-[16px] text-xl text-[#666] dark:text-white font-normal tracking-[1.6px] leading-[30px] w-full sm:w-auto">
                    ...
                    <div className="flex flex-col-reverse sm:flex-row justify-center items-center lg:px-[121px] px-14 mb-16 gap-16">
                        ...
                        <div className="w-full sm:w-3/4 pt-14 flex-col justify-center items-center ps-1 mt-[-30px]">
                            ...
                            <p className="font-montserrat text-xl text-[#666] dark:text-white font-normal tracking-[1.6px] leading-[30px] w-full sm:w-auto">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-center lg:px-[121px] px-14 mb-16 gap-16">
                        <div className="w-full sm:w-3/4 pt-14 flex-col justify-center items-center ps-1 mt-[-30px]">
                            ...
                            <p className="font-montserrat text-xl font-normal text-[#666] dark:text-white tracking-[1.6px] leading-[30px] w-full sm:w-auto">
