        ...
        <div className="">
            <div className="sm:ms-12 sm:me-12">
                ...
                <div className="flex justify-center items-center">
                    <h2 className="text-4xl font-mons text-[#003540] dark:text-[#B3E5F1] font-bold mb-[80px] text-center tracking-[4.8px] leading-[75px]">
                ...
                <div className="px-[121px] flex-col justify-center items-center">
                    <h1 className="text-center text-[#003540] dark:text-[#B3E5F1] mb-[20px] text-primary font-mons text-[32px] tracking-[3.2px] font-[500]">
                        Staff Augmentation
                    </h1>
                    <p className="text-aboutCont text-center text-[#666] dark:text-white font-mons font-normal leading-[30px] tracking-[1.6px] mb-[60px]">
                ...
                <div className="flex flex-col sm:flex-row justify-center items-center px-[121px] mb-16 gap-16">
                    <div className="w-full sm:w-3/4 pt-14 flex-col justify-center items-center ps-1 mt-[-30px]">
                        ...
                        <p className="font-mons text-[16px] text-[#666] dark:text-white font-normal tracking-[1.6px] leading-[30px]">
                ...
                <div className="flex flex-col sm:flex-row justify-center items-center px-[121px] mb-16 gap-16">
                    <div className="w-full sm:w-3/4 pt-14 flex-col justify-center items-center ps-1 mt-[-30px]">
                        ...
                        <p className="font-mons text-[16px] font-normal text-[#666] dark:text-white tracking-[1.6px] leading-[30px]">
