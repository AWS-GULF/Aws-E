    ...
    <div className="container mx-auto px-4 sm:px-12 flex flex-col sm:flex-row sm:justify-between  sm:items-center ">
      <div className="sm:w-1/2 w-full text-center  sm:text-left">
        <div className="mb-10 sm:mb-16">
          ...
          <p className= " colorP bg-p  font-mons text-lg sm:text-xl text-secondary tracking-[1.7px] font-light leading-relaxed dark:text-white">
        ...
        <ul className="mt-8 flex justify-center sm:justify-start items-center gap-4 sm:gap-7 bg-text mb-[72px] text-2xl ">
          ...
          <i class="fa-brands fa-behance  w-6 h-6 fa-behance bg-icon transition icon-button"></i>
          <i class="fa-brands fa-instagram  w-6 h-6 fa-instagram bg-icon  transition icon-button"></i>
          <i class="fa-brands fa-linkedin  w-6 h-6 fa-linkedin bg-icon transition icon-button"></i>
          <i class="fa-brands fa-youtube w-6 h-6 fa-facebook bg-icon transition icon-button"></i>
          <i class="fa-brands fa-snapchat fa-facebook  w-6 h-6 bg-icon transition icon-button"></i>
          <i class=" fa-facebook bg-icon  w-6 h-6 transition icon-button fa-brands fa-x-twitter"></i>
      
        </ul>
      </div>
     
      <div className="sm:w-1/2 w-full flex justify-center items-center mt-10 lg:mb-32  md:mb-3 lg:mr-36  sm:mt-0">
        <img
          src={Logo}
