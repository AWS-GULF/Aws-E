      ...
      <div className="flex flex-wrap items-center justify-between text-xl  px-[28px] mx-auto w-full">
        ...
        <Navbar.Collapse>
          <ul className="flex flex-col    mt-4 left-0 font-medium md:flex-row md:mt-0 md:space-x-6 rtl:space-x-reverse">
            ...
            <li>
             <Link to="ourWork" className="block py-2 px-3 lg:py-8  text-[#666] dark:text-white">  Work</Link>
            </li>
            <li>
           <Link to="about" className="block py-2  px-3 lg:py-8  text-[#666]  dark:text-white ">    About </Link> 
            </li>
            <li>
            <Link to="careers"   className="block py-2 px-3  lg:py-8  text-[#666]  dark:text-white">  Careers</Link>
            </li>
            <li>
...
/>
            {/* Contact Us Button */}
            <button className="backGroundButton rounded-2xl py-4  px-5 mt-1  mx-auto text-amber-50 sm:py-2 sm:px-4 md:py-3 md:px-5 lg:py-4 lg:px-6 lg:my-3 lg:mx-5">
            Contact Us
          </button>
