          ...
          <FlowbiteNavbar.Collapse>
            <ul className="flex flex-col mr-40 mt-4 left-0 font-medium md:flex-row md:mt-0 md:space-x-6 rtl:space-x-reverse">
              ...
              <li className="relative group flex">
                ...
                <a
                  href="#"
                  className="block mt-2 lg:py-6 py-3 lg:px-5 gap-5 text-[#666] dark:text-[#666]"
                >
                  Industries
                </a>
                <i className="fa-solid fa-chevron-down absolute md:block left-[85px]   mt-10 transform -translate-y-1/2 transition-transform   group-hover:rotate-180 text-[#666]"></i>
              ...
              <li className="relative group">
                ...
                >
                  About
                  <i className="fa-solid fa-chevron-down absolute md:block left-[65px] top-1/2 transform -translate-y-1/2 transition-transform group-hover:rotate-180 text-[#666]"></i>
                </a>
                {/* Dropdown Menu */}
            ...
            <i className="fa-solid fa-globe mt-4 md:ml-4 lg:ml-1 pb-3 lg:py-5 text-[#666] dark:text-white">
              {" "}
              العربية
            </i>
            ...
            {/* Contact Us Button */}
            <Button className="backGroundButton bg-[#5BA89C]  rounded-2xl py-4 px-5 mt-1 mx-auto text-amber-50 sm:py-2 sm:px-4 md:py-3 md:px-5 lg:py-4 lg:px-6  lg:my-3 lg:mx-5">
              Contact Us
            </Button>
          </FlowbiteNavbar.Collapse>
        </div>
