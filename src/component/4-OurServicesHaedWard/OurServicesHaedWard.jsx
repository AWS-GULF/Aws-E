        ...
        <div className="text-center lg:mr-32 sm:text-left">
          ...
          <div className="grid gap-4 mt-8 w-full lg:w-[110%] grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="border p-3 rounded-xl min-w-[300px] flex-1 bg-tooHover">
              ...
              />
              <div>
                <h2 className="text-[#003540] pt-4 text-base font-[600] font-montserrat tracking-[1.6px] font-mons dark:text-[#B3E5F1]">
                  Quality Assurance
                </h2>
                ...
                <div className="card-actions justify-start mt-11 bg-text">
                  <Link to="QualityAssurance1">
                    <button className="underline dark:text-[#B3E5F1]">
                      See More
                    </button>
                  </Link>
                </div>
            ...
            <div className="border p-3 rounded-xl min-w-[300px] bg-tooHover flex-1">
              ...
              />
              <div>
                <h2 className="text-[#003540] font-montserrat pt-4 text-base font-[600] tracking-[1.6px] font-mons dark:text-[#B3E5F1]">
                  Mobile Development
                </h2>
                <p className="font-mons text-[15px] font-[500] text-[#666] mt-4 leading-6 dark:text-white font-montserrat">
                ...
                <div className="card-actions justify-start mt-11">
                  <Link to="MobileDevelopment">
                    <button className="underline bg-text dark:text-[#B3E5F1]">
                      See More
                    </button>
                  </Link>
                </div>
            ...
            <div className="border p-3 rounded-xl min-w-[300px] bg-tooHover flex-1">
              ...
              />
              <div>
                <h2 className="text-[#003540] pt-4 font-montserrat text-base font-[600] tracking-[1.6px] font-mons dark:text-[#B3E5F1]">
                  Web Development
                </h2>
                <p className="font-mons text-[15px] font-[500] text-[#666] mt-2 leading-6 dark:text-white font-montserrat">
            ...
            <div className="border p-3 rounded-xl min-w-[300px] bg-tooHover flex-1">
              ...
              <div>
                ...
                <p className="font-mons text-[15px] lg:py-3 font-[500] text-[#666] mt-2 leading-6 dark:text-white font-montserrat">
            ...
            <div className="border p-3 rounded-xl min-w-[300px] bg-tooHover flex-1">
              ...
              <div>
                ...
                <p className="font-mons text-[15px] font-[500] text-[#666] mt-2 font-montserrat leading-6 dark:text-white">
