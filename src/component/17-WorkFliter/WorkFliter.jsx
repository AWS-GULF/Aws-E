...
export default function WorkFilter() {
  ...
  const cardsData = [
    ...
    { id: 3, category: "IT & Hardware", src: ExploreOurServices9, title: "clients", description: "Nafaa is the first complete and integrated ....", route: "/SSSproject" },
    ...
    { id: 5, category: "Staff Augmentation", src: ExploreOurServices9, title: "clients", description: "Nafaa is the first complete and integrated .....", route: "/SSSproject" },
    ...
    { id: 9, category: "Quality Assurance", src: ExploreOurServices9, title: "clients", description: "Nafaa is the first complete and integrated ....", route: "/SSSproject" },
  ];
