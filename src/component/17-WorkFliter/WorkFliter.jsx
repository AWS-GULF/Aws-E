...
export default function WorkFliter() {
    ...
    <div className="container sm:mx-auto sm:p-6">
      ...
      <div className="cards mb-[100px] flex   flex-wrap gap-2 sm:gap-4  justify-center">
        {filteredCards.map((card) => (
          <div className="card py-2  w-[45%] sm:w-[30%] bg-base-900 sm:h-[500px] border-1 border border-stroke p-4">
            <figure>
              <img
                className="sm:w-[405px] sm:h-[382px] w-full h-[200px]  dark:text-[#B3E5F1] "
                src={card.src}
                alt={card.title}
              />
            </figure>
            <div className="flex-col items-start justify-start">
              <h2 className="text-[12px] sm:text-[14px] text-primary  font-mons dark:text-[#B3E5F1] font-[600] sm:tracking-[1.6px] mb-2 ">
                {card.title}{" "}
              </h2>
              <div className="sm:flex sm:flex-row sm:justify-center sm:items-center  dark:text-white  ">
                <p className="font-mons text-[10px] sm:text-[15px] font-[500] dark:text[#666] ">
                  {card.description}
                </p>
